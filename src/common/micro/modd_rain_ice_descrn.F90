...
!
REAL,DIMENSION(7) :: XRTMIN ! Min values allowed for the mixing ratios
...
!
TYPE(RAIN_ICE_DESCR_t), TARGET, SAVE :: RAIN_ICE_DESCRN
!
REAL,DIMENSION(:),POINTER :: XLBC=>NULL()
real, dimension(:), pointer :: XRTMIN=>NULL()
...
END SUBROUTINE RAIN_ICE_DESCR_ASSOCIATE
!
