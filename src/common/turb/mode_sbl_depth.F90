...
!
USE MODE_BL_DEPTH_DIAG, ONLY : BL_DEPTH_DIAG_1D
!
IMPLICIT NONE
!
!
...
CALL BL_DEPTH_DIAG_3D(D,ZUSTAR2,PZZ(:,IKB),ZWIND,PZZ,CSTURB%XFTOP_O_FSURF,ZSBL_DYN)
!$mnh_expand_array(JIJ=IIJB:IIJE)
...
!
CALL BL_DEPTH_DIAG_3D(D,ZQ0,PZZ(:,IKB),PWTHV,PZZ,CSTURB%XFTOP_O_FSURF,ZSBL_THER)
!$mnh_expand_array(JIJ=IIJB:IIJE)
