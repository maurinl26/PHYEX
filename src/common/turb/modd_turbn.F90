...
!
CONTAINS
   subroutine TURBN_ASSOCIATE()
      IMPLICIT NONE

!
! Current model is set to model KTO
      XIMPL => TURBN%XIMPL
      XTKEMIN => TURBN%XTKEMIN
      XCED => TURBN%XCED
      XCTP => TURBN%XCTP
      XCSHF => TURBN%XCSHF
      XCHF => TURBN%XCHF
      ...
      XCPR1 => TURBN%XCPR1
      XCADAP => TURBN%XCADAP
      CTURBLEN => TURBN%CTURBLEN
      CTURBDIM => TURBN%CTURBDIM
      LTURB_FLX => TURBN%LTURB_FLX
      LHARAT => TURBN%LHARAT
      LTURB_DIAG => TURBN%LTURB_DIAG
      LSIG_CONV => TURBN%LSIG_CONV
      LRMC01 => TURBN%LRMC01
      CTOM => TURBN%CTOM
!XBL_DEPTH=>TURBN%XBL_DEPTH !Done in FIELDLIST_GOTO_MODEL
!XSBL_DEPTH=>TURBN%XSBL_DEPTH !Done in FIELDLIST_GOTO_MODEL
!XWTHVMF=>TURBN%XWTHVMF !Done in FIELDLIST_GOTO_MODEL
      XDYP => TURBN%XDYP
      XTHP => TURBN%XTHP
      XTR => TURBN%XTR
      XDISS => TURBN%XDISS
      XLEM => TURBN%XLEM
      XSSUFL_C => TURBN%XSSUFL_C
      XSSVFL_C => TURBN%XSSVFL_C
      XSSTFL_C => TURBN%XSSTFL_C
      XSSRFL_C => TURBN%XSSRFL_C
      LLEONARD => TURBN%LLEONARD
      XCOEFHGRADTHL => TURBN%XCOEFHGRADTHL
      XCOEFHGRADRM => TURBN%XCOEFHGRADRM
      XALTHGRAD => TURBN%XALTHGRAD
      XCLDTHOLD => TURBN%XCLDTHOLD
      XLINI => TURBN%XLINI
      LROTATE_WIND => TURBN%LROTATE_WIND
      LTKEMINTURB => TURBN%LTKEMINTURB
      LPROJQITURB => TURBN%LPROJQITURB
      LSMOOTH_PRANDTL => TURBN%LSMOOTH_PRANDTL
      XMINSIGS => TURBN%XMINSIGS
      XBL89EXP => TURBN%XBL89EXP
      XUSRBL89 => TURBN%XUSRBL89
      NTURBSPLIT => TURBN%NTURBSPLIT
      LCLOUDMODIFLM => TURBN%LCLOUDMODIFLM
      CTURBLEN_CLOUD => TURBN%CTURBLEN_CLOUD
      XCOEF_AMPL_SAT => TURBN%XCOEF_AMPL_SAT
      XCEI_MIN => TURBN%XCEI_MIN
      XCEI_MAX => TURBN%XCEI_MAX
      XCEI => TURBN%XCEI
      LTURB_PRECIP => TURBN%LTURB_PRECIP

   END SUBROUTINE TURBN_ASSOCIATE
